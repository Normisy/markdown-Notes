...
断言为我们提供了一个编程的底层思路：我们的目的是**将需求投射到代码上**，断言允许我们**直接对这段代码应该实现的功能做出规约**，只要你断言写得够多，检查的粒度够细，代码的编写就变成了很清晰的事情了（因此，甚至有工具能够根据断言来自动编写过程中的代码），也就是你对每一行代码之后的程序状态情况了然于心，通过控制开头和结果就能获得一个正确的程序
